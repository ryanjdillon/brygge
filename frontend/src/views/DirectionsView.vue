...
<template>
  <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
    <h1 class="text-3xl font-bold text-slate-900">{{ t('directions.title') }}</h1>
    ...
    <div class="mt-10 grid gap-10 lg:grid-cols-2">
      <section>
        ...
        <div class="mt-4 rounded-lg border border-slate-200 p-4">
          ...
          <dd class="mt-1 text-slate-600">{{ t('directions.landInstructions') }}</dd>
        </div>
      </section>
      ...
      <section>
          ...
          >
            <template #overlay>
              <a
                ...
                download
                class="absolute bottom-3 left-3 z-10 flex items-center gap-2 rounded-lg bg-white px-4 py-2.5 text-sm font-medium text-slate-900 shadow-lg transition hover:bg-slate-50"
              >
        ...
        <dl class="mt-4 space-y-4">
          ...
          <div class="rounded-lg border border-slate-200 p-4">
            ...
            <dd class="mt-1 font-mono text-slate-900">Ch 16 / Ch 73</dd>
          </div>

          <div class="rounded-lg border border-slate-200 p-4">
            <dt class="text-sm font-medium text-slate-500">{{ t('directions.approach') }}</dt>
            <dd class="mt-1 text-slate-600">{{ t('directions.approachNotes') }}</dd>
          </div>

          <div class="rounded-lg border border-slate-200 p-4">
            <dt class="text-sm font-medium text-slate-500">{{ t('directions.depth') }}</dt>
            <dd class="mt-1 text-slate-600">{{ t('directions.depthInfo') }}</dd>
          </div>
        </dl>
      </section>
    </div>
